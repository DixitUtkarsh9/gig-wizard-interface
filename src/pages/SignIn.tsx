...
const SignIn = () => {
  ...
  const handleSocialSignIn = (provider: string) => {
    // Here we would integrate with Supabase OAuth
    toast({
      ...
      <div className="container max-w-md">
        <div className="bg-white p-8 rounded-lg shadow-md">
          ...
          <form onSubmit={handleSignIn}>
            ...
            <Button 
              type="submit"
              className="w-full bg-secondary text-primary hover:bg-secondary/90 py-3"
              disabled={isLoading}
            >
          ...
          <div className="mt-6">
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              <button 
                className="flex justify-center items-center py-2.5 border rounded-md hover:bg-gray-50 transition-colors"
